      ...
      <div className="flex flex-col items-center justify-center bg-[#09090b] px-8 py-12 min-h-screen">
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-zinc-800 bg-zinc-900 hover:bg-zinc-800 hover:border-zinc-700 text-white text-sm font-medium transition-all"
            >
